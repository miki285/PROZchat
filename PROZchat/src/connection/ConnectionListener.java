...
public class ConnectionListener extends Thread {
	 ...
	 */
	public ConnectionListener(final ServerSocket serverSocket, BlockingQueue<ApplicationEvent> eventQueue, HashMap<UserId, ObjectOutputStream> userOutputStreamMap )
	{
	...
	/*
	 * Metoda klasy connectionListener która nas³uchuje po³¹czeñ od nowych klientów
	 */
	public void run()
	{
		while(true)
		{
			try
			{
				...
				ClientThread clientThread= new ClientThread(usrSocket, userOutputStreamsMap, eventQueue);
				clientThread.start();
			}
			catch(IOException e){
